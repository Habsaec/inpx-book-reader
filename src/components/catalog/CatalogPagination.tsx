...
export default function CatalogPagination({
  ...
  const btnBase = `min-w-[2rem] h-8 px-2 rounded-lg text-xs font-bold border border-[color:var(--app-border)] transition-colors cursor-pointer active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[color-mix(in_srgb,var(--app-text)_5%,transparent)] ${theme.focusRing}`;
