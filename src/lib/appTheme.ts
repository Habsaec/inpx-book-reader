/** INPX Library Server main UI palette (public/styles.css defaults, not lite). */
export const theme = {
  bg: 'bg-[var(--app-bg)]',
  text: 'text-[var(--app-text)]',
  textMuted: 'text-[var(--app-muted)]',
  header: 'bg-[var(--app-topbar-bg)] border-[color:var(--app-topbar-border)]',
  card: 'bg-[var(--app-card-bg)] border-[color:var(--app-border)] hover:bg-[var(--app-card-bg-hover)]',
  cardSolid: 'bg-[var(--app-surface)] border-[color:var(--app-border)] hover:bg-[var(--app-surface-hover)]',
  cardSecondary: 'bg-[var(--app-surface)] border-[color:var(--app-border)]',
  panel: 'bg-[var(--app-panel-soft)] border-[color:var(--app-border)]',
  input:
    'bg-[var(--app-field-bg)] border-[color:var(--app-border)] text-[var(--app-text)] placeholder:text-[var(--app-placeholder)]',
  inputFocus:
  ...
  chipButton:
    'hover:bg-[var(--app-surface-hover)] active:scale-[0.98] transition-colors duration-200',
  accentBg: 'bg-[var(--app-accent-hover)] hover:bg-[color-mix(in_srgb,var(--app-accent-hover)_88%,#000)] text-white',
  ...
  sheet: 'bg-[var(--app-surface)] border-[color:var(--app-border)] text-[var(--app-text)]',
