...
export function writePushSuccessFields(
  ...
  return {
    ...
    serverPosition: local.position || null,
    serverFb2Href: local.fb2Href ?? null,
    serverSectionIndex: local.sectionIndex ?? null,
    serverTextOffset: local.textOffset ?? null,
    serverTextQuote: local.textQuote ?? null,
    serverTextSectionLength: local.textSectionLength ?? null,
    serverSectionPageFraction: local.sectionPageFraction ?? null,
    serverPaginatorPage: local.paginatorPage ?? null,
    serverPaginatorPages: local.paginatorPages ?? null,
    serverLayoutMode: local.layoutMode ?? null,
    serverSessionId: local.positionSessionId || null,
    positionVersion: 4,
